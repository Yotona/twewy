...
s32 func_ov004_020e9304(BtlArm_Doll* doll, s32 arg1, s32 arg2) {
    ...
    if (temp_lr != 0) {
        s32 var_r4     = 0;
        *doll->unk_14C = 0;
        if (((BtlArm_Doll*)data_ov003_020e71b8->unk3D89C)->actor.isFlipped == FALSE) {
            var_r4 = 1;
        }
        doll->unk_15C = var_r4;
        doll->unk_158 = arg1;
...
void func_ov004_020e9430(BtlArm_Doll* doll) {
    ...
    if (doll->unk_158 != 0) {
        var_r0 = func_ov003_0208c810(doll->actor.position.x, doll->unk_15C, 1);
    } else {
        var_r0 = func_ov003_0208c810(doll->actor.position.x, doll->unk_15C, 0);
        if (var_r0 == NULL) {
            var_r0 = func_ov003_0208c810(doll->actor.position.x, doll->unk_15C, 1);
        }
    }
    if (var_r0 != NULL) {
        ...
        doll->unk_160 = ((BtlArm_Doll*)data_ov003_020e71b8->unk3D89C)->actor.position.x;
        doll->unk_164 = doll->actor.position.y;
        doll->unk_168 = doll->actor.position.z;
...
void func_ov004_020e951c(BtlArm_Doll* doll) {
    ...
    while (var_r4 != NULL) {
        if (func_ov003_0208c79c(var_r4, doll->unk_15C) != 0) {
            var_r5 += var_r4->actor.position.y;
            var_r6 += var_r4->actor.position.z - (var_r4->actor.unk_76 << 0xC);
            var_r7 += 1;
        }
...
void func_ov004_020e9694(BtlArm_Doll* doll, s32 arg1, s32 arg2) {
    ...
    if (doll->actor.isFlipped == 0) {
        var_r1 = doll->actor.position.x - (arg1 << 0xC);
    } else {
        var_r1 = doll->actor.position.x + (arg1 << 0xC);
    }
    func_ov003_0209fc88(1, var_r1, doll->actor.position.y, doll->actor.position.z + (arg2 << 0xC), 0x10, 0);
}

void func_ov004_020e96e0(BtlArm_Doll* doll) {
    doll->unk_15C = (((BtlArm_Doll*)data_ov003_020e71b8->unk3D89C)->actor.isFlipped == FALSE);

    func_ov004_020e929c(doll);
    doll->actor.position.x = doll->unk_140;
    doll->actor.position.y = doll->unk_144;
...
void func_ov004_020e9754(BtlArm_Doll* doll) {
    ...
    func_ov003_02083ab0(1, temp_r3->actor.position.x, temp_r3->actor.position.y, temp_r3->actor.position.z);
}
    ...
    switch (doll->unk_17C) {
        ...
        case 1:
            if (doll->unk_17E == 0) {
                ...
                func_ov003_02082f7c(&doll->actor, 58);
                doll->unk_17E = 29;
            }
            doll->unk_17E--;
            if (doll->unk_17E <= 0) {
...
void func_ov004_020e9a34(BtlArm_Doll* doll) {
    ...
    if (doll->unk_17E > 0) {
        func_02026590(&doll->actor.position.x, doll->unk_160, (u16)doll->unk_17E);
        func_02026590(&doll->actor.position.y, doll->unk_164, (u16)doll->unk_17E);
        func_02026590(&doll->actor.position.z, doll->unk_168, (u16)doll->unk_17E);
        doll->unk_17E--;
    }
    if (doll->unk_17E <= 0) {
        if (doll->unk_148 == 0) {
...
void func_ov004_020e9ce0(BtlArm_Doll* doll) {
    ...
    switch (doll->unk_17C) {
        case 0:
            if (doll->unk_17E == 0) {
                func_ov003_02087f64(0x158, doll->actor.position.x);
        ...
        case 1:
            if (doll->unk_17E == 0) {
                ...
                doll->actor.zGravity = 0x400;
                func_ov003_02082f7c(&doll->actor, 46);
                doll->unk_17E++;
            }
    ...
    func_ov003_02083ab0(1, doll->actor.position.x, doll->actor.position.y, doll->actor.position.z);
}
...
void func_ov004_020e9eac(BtlArm_Doll* doll) {
    switch (doll->unk_17C) {
        case 0: {
            ...
            if (doll->unk_17E > 0) {
                func_020265d4(&doll->actor.position.x, doll->unk_160, (u16)doll->unk_17E);
                func_020265d4(&doll->actor.position.y, doll->unk_164, (u16)doll->unk_17E);
                func_02026590(&doll->actor.position.z, doll->unk_168, (u16)doll->unk_17E);
                doll->unk_17E--;
            }
            if (doll->unk_17E <= 0) {
        ...
        case 1: {
            if (doll->unk_17E == 0) {
                func_ov003_02087f64(0x161, doll->actor.position.x);
            ...
            if (func_ov004_020e95ec(doll, 0x11U, 0, -0x18) != 0) {
                func_ov003_02087f64(0x162, doll->actor.position.x);
                if (doll->unk_150 == 0) {
        ...
        case 2: {
            if (doll->unk_17E == 0) {
                ...
                func_ov003_02082f7c(&doll->actor, 16);
                doll->unk_17E = 16;
            }
...
void func_ov004_020ea1ac(BtlArm_Doll* doll) {
    if ((doll->unk_17C == 0) && (doll->unk_17E == 0) && (doll->actor.position.x == doll->unk_140) &&
        (doll->actor.position.y == doll->unk_144))
    {
        func_ov004_020e927c(doll, func_ov004_020e9754);
        return;
    ...
    switch (doll->unk_17C) {
        case 0: {
            if (doll->unk_17E == 0) {
                ...
                doll->actor.zGravity = 0x2800;
                func_ov003_02082f7c(&doll->actor, 0xC);
                doll->unk_174          = doll->actor.position.z;
                doll->actor.position.z = 0;
                doll->unk_17E          = 0xC;
            }
            if (doll->unk_17E > 0) {
                func_02026590(&doll->actor.position.x, doll->unk_140, (u16)doll->unk_17E);
                func_02026590(&doll->actor.position.y, doll->unk_144, (u16)doll->unk_17E);
...
void func_ov004_020ea304(BtlArm_Doll* doll) {
    ...
    if (doll->unk_148 != NULL) {
        func_ov003_0208a128(func_ov003_0208a114(14), data_ov003_020e71b8->unk3D89C + 4, doll->unk_148, doll->actor.position.x);
    }
    func_ov004_020e927c(doll, func_ov004_020ea1ac);
}
...
s32 BtlArm_Doll_Init(TaskPool* pool, Task* task, void* args) {
    ...
    CombatActor_Init(&doll->actor, 0);
    doll->unk_14C          = args;
    doll->actor.isFlipped  = 0;
    doll->actor.position.x = (temp_r5->actor.position.x + 0x10000);
    doll->actor.position.y = (temp_r5->actor.position.y + 0x8000);
    doll->actor.position.z = 0;
    doll->actor.zGravity   = 0x400;
    ...
    doll->unk_140 = doll->actor.position.x;
    doll->unk_144 = doll->actor.position.y;
    doll->unk_174 = 0;
    doll->unk_13C = 0;
    doll->unk_148 = 0;
    doll->unk_15C = 1;
...
s32 BtlArm_Doll_Update(TaskPool* pool, Task* task, void* args) {
    ...
    CombatActor_UpdatePhysics(&doll->actor);
...
s32 BtlArm_Doll_Render(TaskPool* pool, Task* task, void* args) {
    ...
    doll->actor.position.z += doll->unk_174;
    CombatActor_Render(&doll->actor, &doll->unk_07C);
