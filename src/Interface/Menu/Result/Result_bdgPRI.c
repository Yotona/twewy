...
static SpriteFrameInfo* Result_bdgPRI_GetFrameInfo(Sprite* sprite, s32 arg, s32 mode);
...
static const SpriteAnimation Result_bdgPRI_Anim = {
    ...
    .unk_04            = 0x50,
    .unk_06            = 0x50,
    .frameInfoCallback = Result_bdgPRI_GetFrameInfo,
    .callbackArg       = 0,
    .owner             = NULL,
...
static SpriteFrameInfo* Result_bdgPRI_GetFrameInfo(Sprite* sprite, s32 arg, s32 mode) {
    Sprite_FrameInfoCallbackSorted(sprite, mode, 0x28A000);
}
