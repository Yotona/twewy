...
static SpriteFrameInfo* MenuEquip_foodGauge_GetFrameInfo(Sprite* sprite, s32 frameIndex, s32 mode);
...
static const SpriteAnimation MenuEquip_foodGauge_Anim = {
    ...
    .unk_04     = 0x50,
    .unk_06     = 0x50,
    .unk_08     = MenuEquip_foodGauge_GetFrameInfo,
    .unk_0C     = 0,
    .unk_10     = 0,
