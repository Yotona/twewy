...
typedef struct {
    ...
    /* 0x08 */ GameState*   gState;     // TODO: Why is there a second gState pointer here when OverlayData also has one?
...
void func_02006f78(OverlayManager* overlayMgr, s32 param_2, OverlayCB func, GameState* param_4, s32 param_5);
