...
typedef enum {
    ...
    INPUT_BUTTON_DEBUG  = 0x2000,
} InputButton;

#define INPUT_ABXY       (INPUT_BUTTON_A | INPUT_BUTTON_B | INPUT_BUTTON_X | INPUT_BUTTON_Y)
#define INPUT_DPAD       (INPUT_BUTTON_UP | INPUT_BUTTON_DOWN | INPUT_BUTTON_LEFT | INPUT_BUTTON_RIGHT)
