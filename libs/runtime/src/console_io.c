...
int __read_console(__file_handle handle, unsigned char* buffer, int* count, void* ref) {
    unsigned long i, n;
...
int __write_console(__file_handle handle, unsigned char* buffer, int* count, void* ref) {
    unsigned long i, n;
