...
#include <MSL/Common/strtold.h>
#include <MSL/Common/strtoul.h>
    ...
    switch (c) {
        ...
        case 'G':
            ...
            if (f.argument_options == char_argument || f.argument_options == short_argument ||
                f.argument_options == intmax_argument || f.argument_options == u32_argument ||
...
int __sformatter(int (*ReadProc)(void*, int, int), void* ReadProcArg, const char* format_str, va_list arg, int is_secure) {
                ...
                if (arg_ptr) {
                    switch (format.argument_options) {
                        ...
                        case intmax_argument:
                            *(u64*)arg_ptr = long_long_num;
                            break;
                        case u32_argument:
                            *(u32*)arg_ptr = long_num;
                            break;
